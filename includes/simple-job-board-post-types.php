...
function job_board_register ()
{
    ...
    $args = array (
        ...
        'capability_type'     => array('jobpost','jobposts'),
        'map_meta_cap'        => true,
    );
    ...
    $labels = array (
        'name' => _x ( 'Location', 'taxonomy singular name', 'presstigers' ),
    ...
    // Add Taxonomy, make it hierarchical (like categories)
    $labels = array (
        'name' => _x ( 'Qualification', 'taxonomy singular name', 'presstigers' ),
        'singular_name' => _x ( 'Job Qualification', 'taxonomy singular name', 'presstigers' ),
        'search_items' => __ ( 'Search Job Qualifications' ),
        'all_items' => __ ( 'All Job Qualifications' ),
        'parent_item' => __ ( 'Parent Job Qualification' ),
        'parent_item_colon' => __ ( 'Parent Job Qualification:' ),
        'edit_item' => __ ( 'Edit Job Qualification' ),
        'update_item' => __ ( 'Update Job Qualification' ),
        'add_new_item' => __ ( 'Add New Job Qualification' ),
        'new_item_name' => __ ( 'New Job Qualification Name' ),
    ...
    $args = array (
        ...
        'show_admin_column' => true,
        'query_var' => true,
        'rewrite' => array ( 'slug' => 'job_qualification' ),
    );

    register_taxonomy ( 'jobpost_qualification', array ( 'jobpost', ), $args );

    // Add Taxonomy, make it hierarchical (like categories)
    $labels = array (
        'name' => _x ( 'Experience', 'taxonomy singular name', 'presstigers' ),
        'singular_name' => _x ( 'Job Experience', 'taxonomy singular name', 'presstigers' ),
        'search_items' => __ ( 'Search Job Experiences' ),
        'all_items' => __ ( 'All Job Experiences' ),
        'parent_item' => __ ( 'Parent Job Experience' ),
        'parent_item_colon' => __ ( 'Parent Job Experience:' ),
        'edit_item' => __ ( 'Edit Job Experience' ),
        'update_item' => __ ( 'Update Job Experience' ),
        'add_new_item' => __ ( 'Add New Job Experience' ),
        'new_item_name' => __ ( 'New Job Experience Name' ),
    ...
    register_taxonomy ( 'jobpost_experience', array ( 'jobpost', ), $args );

    // Add Taxonomy, make it hierarchical (like categories)
    $labels = array (
        'name' => _x ( 'CTC', 'taxonomy singular name', 'presstigers' ),
        'singular_name' => _x ( 'Job CTC', 'taxonomy singular name', 'presstigers' ),
        'search_items' => __ ( 'Search Job CTC' ),
        'all_items' => __ ( 'All Job CTC' ),
        'parent_item' => __ ( 'Parent Job CTC' ),
        'parent_item_colon' => __ ( 'Parent Job CTC:' ),
        'edit_item' => __ ( 'Edit Job CTC' ),
        'update_item' => __ ( 'Update Job CTC' ),
        'add_new_item' => __ ( 'Add New Job CTC' ),
        'new_item_name' => __ ( 'New Job CTC Name' ),
        'menu_name' => __ ( 'CTC' ),
    );
    ...
    $args = array (
        ...
        'show_admin_column' => true,
        'query_var' => true,
        'rewrite' => array ( 'slug' => 'job_ctc' ),
    );

    register_taxonomy ( 'jobpost_ctc', array ( 'jobpost', ), $args );
...
function jobpost_applicants ()
{
    ...
    $args = array (
        ...
        'capability_type'     => array('jobpost_applicant','jobpost_applicants'),
                        'map_meta_cap'        => true,
        'capabilities' => array (
            'create_posts' => false,
        )
